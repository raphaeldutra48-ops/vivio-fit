...
async function main(): Promise<void> {
  /*
    Sem `senhaHash`: quem autentica é o Supabase Auth, e a senha das contas da
    semente mora em `auth.users`, criada por `semear-auth`. O hash argon2 que
    ficava aqui só servia ao login da API, que saiu do repositório.
  */
  ...
  console.log('\nSeed concluído. Para entrar, rode `semear-auth` (senha de todos: Senha@123).');
